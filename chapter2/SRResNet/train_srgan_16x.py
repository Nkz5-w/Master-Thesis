...
scaling_factor = 16  # the scaling factor for the generator; the input LR images will be downsampled from the target HR images by this factor
...
srresnet_checkpoint = "./checkpoints/checkpoint_srresnet_16_new.pth.tar"  # filepath of the trained SRResNet checkpoint used for initialization
...
# Learning parameters
checkpoint = './checkpoints/checkpoint_srgan_16.pth.tar' # path to model (SRGAN) checkpoint, None if none
batch_size = 16  # batch size # 此处16改为64
start_epoch = 0  # start at this epoch
iterations = 5000  # number of training iterations # 此处由2e5变为1e3
...
def main():
    ...
    if checkpoint is None:
        ...
        print("Loading pretrained SRResNet generator...")
    ...
    # Epochs
    for epoch in range(0, epochs):  # 此处epoch有修改
        ...
        torch.save({'epoch': epoch,
                    ...
                    'optimizer_g': optimizer_g,
                    'optimizer_d': optimizer_d},
                   'checkpoints/checkpoint_srgan_16_new.pth.tar')
