...
# Learning parameters
checkpoint ="./checkpoints/checkpoint_srresnet_8_aoa.pth.tar"  # path to model checkpoint, None if none
batch_size = 32  # batch size #此处16改成64
start_epoch = 0  # start at this epoch
iterations = 250000  # number of training iterations # 此处由1e6变为1e4
...
def main():
    ...
    # Epochs
    for epoch in range(0, epochs):  # 此处将原本的epochs改成了1
        ...
        torch.save({'epoch': epoch,
                    'model': model,
                    'optimizer': optimizer},
                   'checkpoints/checkpoint_srresnet_8_aoa.pth.tar')
