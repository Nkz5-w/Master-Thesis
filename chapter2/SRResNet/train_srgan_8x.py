...
srresnet_checkpoint = "./checkpoints/checkpoint_srresnet_8_ckm.pth.tar"  # filepath of the trained SRResNet checkpoint used for initialization
...
# Learning parameters
checkpoint = './checkpoints/checkpoint_srgan_8_ckm.pth.tar' # path to model (SRGAN) checkpoint, None if none
batch_size = 32  # batch size # 此处16改为64
...
def main():
    ...
    for epoch in range(0, epochs):
        ...
        torch.save({'epoch': epoch,
                    ...
                    'optimizer_g': optimizer_g,
                    'optimizer_d': optimizer_d},
                   'checkpoints/checkpoint_srgan_8_ckm.pth.tar')
